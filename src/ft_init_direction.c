...
/*   Updated: 2021/01/23 12:24:02 by flpinto          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cube3d.h"

void	init_direction_ew(t_all *all, int y, int x)
{
...
void	init_direction_ns(t_all *all, int y, int x)
{
